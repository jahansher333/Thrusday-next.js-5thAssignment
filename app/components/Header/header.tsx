...
const Header = () => {
    ...
    return (
        <div>
            {/* Header */}
            <header className="bg-[#A29875]  h-[135.01px] flex justify-between items-center pl-10 pr-10 ">
                {/* Logo */}
                <div className="flex">
                ...
                <div className="m-3">
                    <form action="" className="relative">
                        <div className="">
                            <input type="text" placeholder="Search for Gold Jewellery, Diamond Jewellery and more…" className="w-[768.89px] h-[56.24px]  rounded-md bg-slate-50 placeholder:pl-[20px]"/>
